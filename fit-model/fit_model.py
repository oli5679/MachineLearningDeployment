...
def main():
    '''
    Fits the model and creates model artefacts (binary and PMML)
    '''
    # Load the data 
    ...
    gbdt_pipeline = Pipeline([('imputer', SimpleImputer(missing_values=np.nan, strategy='mean')), 
